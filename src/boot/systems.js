...
export const SYSTEMS = [
  ...
  },
  {
    ...
    notes: 'Scheda XT, BIOS libero, VGA e Sound Blaster: la macchina su cui gira il DOS.',
    available: true,
    load: () => import('../systems/pc/index.js'),
  },
  {
    id: 'pc386',
    label: 'PC 386 — BIOS di Bochs / FreeDOS',
    year: 1990,
    cpu: 'Intel 80386DX + 387 @ 33 MHz',
    memory: '8 MB, VGA, Sound Blaster, CD-ROM, mouse PS/2',
    notes: 'Modo protetto e modo virtuale 8086: la macchina su cui è uscito Windows 3.1.',
    available: true,
    load: () => import('../systems/pc386/index.js'),
  },
  {
    id: 'pentium',
    ...
    memory: '32 MB, VGA, Sound Blaster, CD-ROM, bus PCI',
